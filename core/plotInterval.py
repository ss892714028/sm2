...
def plot_interval(question_id, student_id):
    ...
    ax1.plot(t, interval, color=color)
    ...
    ax2.plot(t, evaluation, color=color)
...
if __name__ == '__main__':
    plot_interval(question_id='21', student_id='1')
    plot_interval(question_id='1', student_id='1')
    plot_interval(question_id='1', student_id='102')
    plot_interval(question_id='888', student_id='102')